<?php
    ...
    if (is_front_page() || is_tree('6886') || is_tree('7124') || is_tree('21159') || get_post_type($post->ID) == "libtech_snowboards" || get_post_type($post->ID) == "libtech_bindings" || is_tree('18848') || get_post_type($post->ID) == "libtech_team_snow" || in_category( '220' ) || post_is_in_descendant_category( '220' )) {
        $GLOBALS['sport'] = "snow";
