...
?>
        <section class="ripper-details bg2 <?php echo $slug; ?>">
        	<div class="section-content">
        		<!--<div class="breadcrumb"><a href="/skiing/team/">&lt; Rippers Overview</a></div>-->
        		<h1><?php the_title(); ?></h1>
				...
				<div class="ripper-right">
					<div class="ripper-meta">
						<?php if(get_field('libtech_team_home')) : ?><p class="ripper-home"><span>Home Mountain: </span><?php the_field('libtech_team_home'); ?></p><?php endif; ?>
